...
int main() {
    ...
    do {
        ...
        std::cout << "Dados coletados, processando..." << std::endl;
    ...
    while (true) {
        ...
        for (measurementCounter = 0; measurementCounter < accCollectionLimit; measurementCounter++) {
            ...
            compressionCount();
            //std::cout << "compFreq calculado" << std::endl;
            std::cout << compressoesFeitas << ";" << acceleration[measurementCounter] << std::endl;
        ...
        //std::cout << "compDepth em processo" << std::endl;
        compressionDepth = depthMeasure();
        //std::cout << "compDepth feito" << std::endl;
        compCounter=0;
        riseCounter=0;
    }
    //outFile.close();
